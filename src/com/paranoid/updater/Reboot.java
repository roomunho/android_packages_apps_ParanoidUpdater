    ...
    Thread myThread = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                if (Gapps)
                    Shell.sudo("echo install /sdcard/pa_updater/gapps.zip" + cmd);

                if (Kernel)
                    Shell.sudo("echo install /sdcard/pa_updater/kernel.zip" + cmd);

                if (Prefs)
                    Shell.sudo("echo install /sdcard/pa_updater/pref.zip" + cmd);

                if (WipeCache_DalvikCache) {
                    Shell.sudo("echo wipe cache" + cmd);
                    Shell.sudo("echo wipe dalvik" + cmd);
                }
